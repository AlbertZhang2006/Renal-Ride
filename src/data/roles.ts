...
export const roleNavItems: Record<UserRole, NavItem[]> = {
  ...
  clinic: [
    { label: 'Command Center', path: '/app/clinic', icon: 'dashboard' },
    { label: 'Risk Queue', path: '/app/clinic/risk-queue', icon: 'risk-queue', badge: '5', badgeColor: 'red' },
    { label: 'Return Rides', path: '/app/clinic/returns', icon: 'return-rides', badge: '2', badgeColor: 'amber' },
